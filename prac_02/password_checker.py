...
Fill in the TODOs to complete the task, "skeleton" code to help you get started
"""
...
def is_valid_password(password):
    ...
    for char in password:
        ...
        count_digit += char.isdigit()  # counts digital characters
        count_lower += char.islower()  # counts lowercase characters
        count_upper += char.isupper()  # counts uppercase characters
