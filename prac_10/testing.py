...
# p5. Write and test a function to format a phrase as a sentence,
...
def format_a_sentence(phrase):
    ...
    'It is an ex parrot.'
    >>> format_a_sentence('capital finishing with a full stop')
    'Capital finishing with a full stop.'
    """
    if not phrase[0].isupper() and phrase[-1] != '.':
